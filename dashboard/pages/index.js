...
function OnboardingWizard({ onComplete }) {
  ...
  const [step, setStep] = useState('choose'); // choose | spark | oracle | wild
  ...
  async function handleSparkSubmit() {
    ...
    if (sparkQ < 5) {
      ...
      // Build MASTER.json from SPARK answers
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-anima-bg-card rounded-lg border border-anima-border p-6">
            <p className="text-anima-text text-sm mb-4">
              Copy the prompt from <code className="text-anima-gold">onboarding/oracle_prompt.txt</code> into
              Claude, ChatGPT, Gemini, or Deepseek. Answer 12 questions. Paste the JSON output below.
            </p>
  ...
  // WILD — just show a confirmation (already started)
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
